      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0" onClick={closeMobile}>
            ...
            />
            <span className="text-lg font-bold tracking-tight text-black">ASTREM</span>
          </Link>
        ...
        <nav className="flex flex-col px-4 py-6 gap-1 overflow-y-auto h-[calc(100%-4rem)]">
          {navLinks.map((link) =>
            link.children ? (
              <div key={link.href}>
                <button
                  className="flex w-full items-center justify-between py-3 text-base font-medium text-gray-800 hover:text-black"
          ...
          <div className="mt-auto pt-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex w-full items-center justify-center gap-2 rounded-full bg-black px-4 py-3 text-sm font-semibold text-white hover:bg-gray-800 transition-colors"
              onClick={closeMobile}
            >
